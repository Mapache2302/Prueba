...
class AlumnoOBJ:
    ...
    def setData(self, data):
        self.CodAlumno =data[0]
        self.NombreAlumno = data[1]
        self.Correo = data[2]
    ...
    try:
       ...
       with pool.connect() as db_conn:
            ...
            insert_stmt = sqlalchemy.text(
                "INSERT INTO `resultado_formulario` (`codAlumno`, `Pregunta1`, `Pregunta2`, `Pregunta3`, `Pregunta4`, `Pregunta5`, `Pregunta6`, `Recomendacion`, `promedio`) VALUES (:code, :originalidad, :importancia, :coherencia, :metodologia, :validez, :dominio, :recomendaciones, :prom);",
            )
